...
public class EarthquakeActivity extends AppCompatActivity {
  ...
  */
    ...
    private static final String Earthquake_Url ="https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&orderby=time&minmag=6&limit=10";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        earthquakeAsyncTask.execute(Earthquake_Url);
    }
